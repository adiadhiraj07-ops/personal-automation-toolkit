...
| `newsletter-outreach/` | Newsletter-style cold-outreach email (real story + metrics, zine-like design) sent via Gmail SMTP with inline CID images -- no image hosting needed. Documents the four-agent pipeline around it (find leads, verify emails, create the newsletter, send and monitor the inbox) in its `SKILL.md` |
